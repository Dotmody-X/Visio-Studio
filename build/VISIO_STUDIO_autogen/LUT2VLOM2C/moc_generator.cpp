...
void Generator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Generator::*)()>(_a, &Generator::generationStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Generator::*)(int )>(_a, &Generator::generationProgress, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Generator::*)(const QImage & )>(_a, &Generator::generationFinished, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Generator::*)(const QString & )>(_a, &Generator::generationFailed, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (Generator::*)()>(_a, &Generator::generationCancelled, 4))
            return;
    }
}
