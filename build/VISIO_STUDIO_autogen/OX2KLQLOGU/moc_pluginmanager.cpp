...
template <> constexpr inline auto PluginManager::qt_create_metaobjectdata<qt_meta_tag_ZN13PluginManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'pluginsLoaded'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'pluginLoaded'
        QtMocHelpers::SignalData<void(PluginInterface *)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
    };
...
void PluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PluginManager::*)()>(_a, &PluginManager::pluginsLoaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PluginManager::*)(PluginInterface * )>(_a, &PluginManager::pluginLoaded, 1))
            return;
    }
}
