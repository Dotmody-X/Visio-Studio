...
template <> constexpr inline auto BasePlugin::qt_create_metaobjectdata<qt_meta_tag_ZN10BasePluginE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<BasePlugin, qt_meta_tag_ZN10BasePluginE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject BasePlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10BasePluginE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10BasePluginE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10BasePluginE_t>.metaTypes,
    nullptr
} };
...
void *BasePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10BasePluginE_t>.strings))
