...
template <> constexpr inline auto DitheringPlugin::qt_create_metaobjectdata<qt_meta_tag_ZN15DitheringPluginE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<DitheringPlugin, qt_meta_tag_ZN15DitheringPluginE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject DitheringPlugin::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15DitheringPluginE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15DitheringPluginE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15DitheringPluginE_t>.metaTypes,
    nullptr
} };
...
void *DitheringPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15DitheringPluginE_t>.strings))
